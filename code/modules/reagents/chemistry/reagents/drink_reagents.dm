...
/datum/reagent/consumable/roy_roger/on_mob_life(mob/living/carbon/M, delta_time, times_fired)
	M.Jitter(6) //not as strong as coffe, still this is a lot of sugar
	M.drowsyness = max(0,M.drowsyness-5)
	M.adjust_bodytemperature(-5 * TEMPERATURE_DAMAGE_COEFFICIENT, M.get_body_temp_normal())
	return ..()
...
/datum/reagent/consumable/cinderella/on_mob_life(mob/living/carbon/M)
	M.adjust_disgust(-5)
	return ..()
...
/datum/reagent/consumable/italian_coco/on_mob_life(mob/living/carbon/M)
	M.adjust_bodytemperature(5 * TEMPERATURE_DAMAGE_COEFFICIENT, 0, M.get_body_temp_normal())
	..()
...
/datum/reagent/consumable/shirley_temple/on_mob_life(mob/living/carbon/M)
	M.adjust_disgust(-3)
	..()
...
/datum/reagent/consumable/agua_fresca/on_mob_life(mob/living/carbon/M)
	M.adjust_bodytemperature(-8 * TEMPERATURE_DAMAGE_COEFFICIENT, 0, M.get_body_temp_normal())
