//I don't know how to modify the global list inits modularly, or if that's even possible, so i'm prtty much just copypsting jobs.dm and changing what i need to.
